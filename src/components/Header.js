...
const Header = () => {
  ...
  return (
    <div className='absolute px-8 py-2 bg-gradient-to-b from-black z-20 w-full flex flex-col md:flex-row  justify-between '>
                      {/* by default mobile phone md:for medium devices sm: for small devices */}
       ...
       {user && (
        <div className='flex p-3 justify-between'>
         ...
         <img src={user?.photoURL}  alt="photo-git" className='w-12 h-12 hidden md:block'/>
